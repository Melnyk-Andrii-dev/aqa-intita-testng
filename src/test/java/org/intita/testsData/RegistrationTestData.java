...
public class RegistrationTestData {
    ...
    public Object[][] getData() {
        return new Object[][]{
                {"" + RandomStringUtils.randomNumeric(5, 6) + "@gmail.com", "123", null},
                {"", "", IncorrectInputFieldMessage.INCORRECT_EMAIL_MESSAGE},
                {"", "", IncorrectInputFieldMessage.INCORRECT_PASSWORD_MESSAGE}
        };
    }
